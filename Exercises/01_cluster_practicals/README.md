...
```bash
conda create --name popgen -c kaspermunch -c conda-forge -c plotly slurm-jupyter jupyterlab pandas ipympl nodejs ipython seaborn statsmodels popgen-dashboards
```
