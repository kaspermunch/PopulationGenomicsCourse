...
```bash
conda create --name popgen -c anaconda -c conda-forge -c plotly -c kaspermunch openssl slurm-jupyter jupyterlab pandas ipympl nodejs ipython seaborn statsmodels popgen-dashboards
```
